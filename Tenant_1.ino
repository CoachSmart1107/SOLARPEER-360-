...
void checkIRSensor(int pin, bool &flag, int sensorNumber) {
  ...
  if (value == LOW && !flag) {
    flag = true;
    String msg = "⚠️ Obstacle detected by IR Sensor " + String(sensorNumber) + " at TENANT 1.";
    Serial.println(msg);
